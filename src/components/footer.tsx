...
export default function Footer() {
  return (
    <footer className="bg-[#1e3a4a] text-white py-12">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-semibold text-lg mb-4">Our Products</h3>
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-300 hover:text-white">Merchant payments</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white">Hosted payments</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white">POS</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white">P2P payments</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-300 hover:text-white">Fees</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-300 hover:text-white">Get Started</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white">Plugins & SDKs</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white">Code Samples</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-sm flex gap-10 text-gray-400">
            ...
            <p>© 2022 PayUnit. All rights reserved</p>
          </div>
        </div>
      </div>
    </footer>
